          ...
          {groups.map(({ year, items }) => (
            <section key={year}>
              <div className="mb-6 flex items-baseline justify-between border-b border-stone-200 pb-2">
                <h2 className="font-display text-5xl font-light tracking-tight tabular-nums text-stone-900 sm:text-6xl">
                  {year}
                </h2>
                  ...
                  <li key={n.slug}>
                    ...
                    >
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        {n.tags.length > 0 && (
                          <div className="mt-3 flex flex-wrap gap-x-3 text-[10px] uppercase tracking-[0.18em] text-stone-400">
                            {n.tags.map((t) => (
                              <span key={t}>{t}</span>
                            ))}
                          </div>
                      ...
                      <time
                        ...
                        className="shrink-0 font-mono text-xs uppercase tracking-wider text-stone-400 tabular-nums"
                      >
