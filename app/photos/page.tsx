    ...
    <>
      <Container className="max-w-5xl">
        <div className="py-12 sm:py-16">
          ...
          <div className="mt-10 flex flex-wrap items-baseline gap-x-8 gap-y-2 border-y border-stone-200 py-4 text-[11px] uppercase tracking-[0.18em] text-stone-500 dark:text-stone-400 dark:border-stone-800">
            <span className="flex items-baseline gap-2">
