    ...
    <li className="py-3">
      ...
      >
        <div className="min-w-0 flex-1">
          ...
          <h4 className="mt-0.5 font-serif text-lg text-stone-900 transition-colors group-hover:text-rose-700">
            {review.name}
          </h4>
        </div>
    ...
    <Container className="max-w-4xl py-12 sm:py-16">
      ...
      <div className="mt-8 border-b border-stone-300 pb-10">
        <div className="mb-4 flex items-baseline justify-between gap-4 text-[11px] uppercase tracking-[0.22em] text-stone-500">
          ...
          <span className="font-mono text-stone-400">{period}</span>
        </div>
            ...
            <ol className="divide-y divide-stone-100">
              {issue.notes.map((n) => (
                <li key={n.slug} className="py-3">
                  ...
                  >
                    <div>
                      <h4 className="font-serif text-lg text-stone-900 transition-colors group-hover:text-rose-700">
                        {n.title}
                      </h4>
                      {n.description && (
